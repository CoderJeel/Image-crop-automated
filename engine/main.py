...
def img_alligned(IMG_name,landmarks_model_path):
    """
    ...
    parser.add_argument('--raw_dir',default='input_data', help='Directory with raw images for face alignment')
    parser.add_argument('--aligned_dir',default='output_file', help='Directory for storing aligned images')
